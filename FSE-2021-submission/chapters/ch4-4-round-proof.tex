...
\begin{itemize}[leftmargin=10mm]
	...
	\begin{itemize}
		...
		\item $\left(y \oplus k_{4}\right)[j]\in V_4^{(0)}$ and $(b\xor T^{-1}(k_3)) [i]\in V_3^{(1)}$.
	\end{itemize}
%
...
Regarding \bthree, for each of the $w^2q$ choices of $(x,a,b,y)\in\mathcal{Q}_{C}'$ and indices $i, j \in \{1, \ldots, w\}$, since $k_{0}$ and $k_{4}$ are uniform and independent, the probability to have $(x \oplus k_{0})[i]\in U_1^{(0)}$ and $(y \oplus k_{4})[j]\in V_4^{(0)}$ is $p^2/N^2$. Thus
%
$$
