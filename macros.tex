...
\newcommand\beight{\text{(B-8)}\xspace}
\newcommand\bnine{\text{(B-9)}\xspace}
\newcommand\bten{\text{(B-10)}\xspace}
\newcommand\beleven{\text{(B-11)}\xspace}
\newcommand\btwelve{\text{(B-12)}\xspace}
\newcommand\bthirteen{\text{(B-13)}\xspace}
\newcommand\bfourteen{\text{(B-14)}\xspace}
\newcommand\bfifteen{\text{(B-15)}\xspace}
\newcommand\bsixteen{\text{(B-16)}\xspace}
...
\newcommand\bi{\text{(B-}i)\xspace}
\newcommand\ci{\text{(C-}i)\xspace}
\newcommand\hi{\text{(H-}i)\xspace}
\newcommand\coll{\mathsf{Coll}\xspace}
\newcommand\pcoll{\mathsf{pcoll}\xspace}
\newcommand\pred{\mathsf{Bad}\xspace}
\newcommand\vect{\ensuremath{\mathbf{vec}}\xspace}
\newcommand\free{\mathsf{Free}\xspace}
\newcommand\ev{\mathsf{Evt}\xspace}
...
\newcommand\dis{\ensuremath{\mathcal{D}}\xspace}
...
\newcommand\spn{\ensuremath{\mathsf{SP}}\xspace}
