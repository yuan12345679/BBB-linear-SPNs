...
%	\end{itemize}
	%
	%
%	Regarding $k_3,S_1,S_2,S_5,S_6$, and $\mathcal{Q}_S'$:
	%
	%
%	\begin{itemize}[leftmargin=10mm]
%		\item[\bfive]
...
\end{lemma}
\begin{proof}
The analyses of the conditions just follow Lemma \ref{lemma:bad-tau-4-rounds} and thus we omit. The crux lies in the conditions \cfive and \csix......
%
\begin{itemize}
	\item 0
	\item 0
